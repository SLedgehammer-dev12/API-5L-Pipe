# Sürüm Notları / Release Notes - v2.2.0

## 🚀 API 5L PSL1/PSL2 & BOTAŞ Boru Kalite Güvence, Et Kalınlığı Tasarım ve Akıllı ITP Denetim Süiti (v2.2.0)

Bu majör-minör sürüm (**v2.2.0**), **Boru Kalite Güvence Matrisinde hesaplanan tüm boyutsal toleransların ITP Akıllı Denetim Motoruna entegrasyonunu** ve **SAWH Helisel Sarım & Çift Taraflı Tozaltı Kaynağı (SAW) Canlı 3D/2D İnteraktif Simülasyon Motorunu (`SawhSimulationEngine`)** sunar.

---

### 🌟 v2.2.0 ile Gelen Başlıca Yenilikler
