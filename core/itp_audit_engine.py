...
class ITPAuditEngine:
    ...
    TEST_MATCHER_KEYWORDS = {
        "chemical_heat": ["ısı analizi", "döküm analizi", "heat analysis", "ladle analysis", "cast analysis"],
        "chemical_product": ["ürün analizi", "product analysis", "check analysis"],
        "tensile_body": ["gövde çekme", "pipe body tensile", "body tensile", "çekme testi", "tensile test", "transverse tensile"],
        "tensile_weld": ["kaynak çekme", "weld tensile", "weld seam tensile", "kaynak dikişi çekme"],
        "cvn_body": ["gövde çentik", "gövde darbe", "cvn body", "charpy body", "body impact", "çentik darbe"],
        "cvn_weld_haz": ["kaynak darbe", "itab darbe", "haz impact", "weld impact", "cvn weld", "charpy weld"],
        "dwtt": ["dwtt", "drop weight", "yırtılma testi", "düşen ağırlık"],
        "guided_bend": ["kılavuzlu bükme", "guided bend", "guided-bend", "kök bükme", "kapak bükme", "root bend", "face bend"],
        "flattening": ["düzleştirme", "flattening", "yassıltma"],
        "hydrostatic": ["hidrostatik", "hydrostatic", "su basınç", "basınç testi", "hydro test"],
        "ndt_weld_seam": ["kaynak dikişi ndt", "kaynak ndt", "weld seam ndt", "weld ut", "weld rt", "radyografi", "ultrasonik kaynak"],
        ...
        "ndt_pipe_ends": ["boru uçları ndt", "uç laminasyon", "pipe ends ndt", "laminar testing", "end ut"],
        "ndt_smls_body": ["dikişsiz gövde ndt", "smls body ndt", "flux leakage", "gövde ut"],
        "residual_stress": ["artık stres", "residual stress", "halka kesme", "stres kontrolü", "ring test", "çevresel gerilme"],
        "dimensional_diameter_ovality": ["dış çap", "ovallik", "çap toleransı", "diameter", "out of roundness", "ovality"],
        "dimensional_wall_thickness": ["et kalınlığı", "wall thickness", "cidar kalınlığı", "thickness verification"],
        "dimensional_length_straightness_bevel": ["doğrusallık", "boy", "alın kaynak ağzı", "straightness", "length", "bevel", "ağız açısı"],
        "visual_surface": ["görsel muayene", "yüzey muayenesi", "visual inspection", "surface inspection", "gözle muayene"],
