...
const I18N_DICTIONARY = {
    tr: {
        ...
        nav_itp_audit: "ITP Akıllı Denetim & AI Okuyucu",
        nav_schematic_3d: "2D / 3D Şematik Gösterim",
        sawh_title: "SAWH Spiral Bant Genişliği, Helis Açısı & Canlı İmalat Simülasyonu",
        sawh_sub: "B = π·D_mid·cos(α) • α = arccos(B/(π·D_mid)) • D_mid = D − t • P = π·D_mid·cot(α)",
        sawh_anim: "Şeridin boruya sarımı ve helisel tozaltı kaynağı (canlı simülasyon)",
    ...
    en: {
        ...
        nav_itp_audit: "ITP Smart Auditor & AI Reader",
        nav_schematic_3d: "2D / 3D Schematic Models",
        sawh_title: "SAWH Spiral Strip Width, Helix Angle & Live Forming Simulation",
        sawh_sub: "B = π·D_mid·cos(α) • α = arccos(B/(π·D_mid)) • D_mid = D − t • P = π·D_mid·cot(α)",
        sawh_anim: "Strip helical forming & submerged arc welding (live simulation)",
